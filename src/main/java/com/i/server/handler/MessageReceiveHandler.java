...
public class MessageReceiveHandler extends AbstractBusinessHandler {
	...
	public MessageReceiveHandler(RabbitmqService rabbitmqService, SmsDao smsDao, String appId, String channelId) {
...
//	protected abstract ChannelFuture reponse(final ChannelHandlerContext ctx, Object msg);
	...
	private ChannelFuture reponse(final ChannelHandlerContext ctx, Object msg) {
		System.out.println("MessageReceiveHandler channeId = " + ctx.channel().id().asLongText());
