...
public abstract class EndpointEntity implements Serializable {
	...
	/**
	 * 有未发送成功的消息，是否重发，默认不重发，可能引起消息丢失。 如果为true，则可能重复发送。
	 **/
	...
	public String toString() {
		return "EndpointEntity [Id=" + Id + ", Desc=" + Desc + ", channelType=" + channelType + ", host=" + host
				+ ", port=" + port + ", maxChannels=" + maxChannels + ", valid=" + valid + ", businessHandlerSet="
				+ businessHandlerSet + "]";
	}
