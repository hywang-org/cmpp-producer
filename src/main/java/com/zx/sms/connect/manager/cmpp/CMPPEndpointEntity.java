...
public abstract class CMPPEndpointEntity extends EndpointEntity {
    ...
    public RedisOperationSets getRedisOperationSets() {
        return redisOperationSets;
    }

    public void setRedisOperationSets(RedisOperationSets redisOperationSets) {
        this.redisOperationSets = redisOperationSets;
    }
    ...
    public String toString() {
        return this.getClass().getSimpleName() + "[groupName=" + groupName + ", userName=" + userName + ", chartset="
                + chartset + ", getId()=" + getId() + ", getDesc()=" + getDesc() + ", getChannelType()="
                + getChannelType() + ", getHost()=" + getHost() + ", getPort()=" + getPort() + ", getMaxChannels()="
                + getMaxChannels() + "]";
    }
