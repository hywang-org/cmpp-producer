...
public class CmppSubmitRequestMessage extends DefaultMessage implements LongSMSMessage<CmppSubmitRequestMessage> {
	...
	// ly add
	private CmppSubmitRequestSelfDefinedMessage cmppSubmitRequestSelfDefinedMessage;
	...
	public String getMsgContent() {
		if (msg instanceof SmsMessage) {
			System.out.println("getMsgContent1");
			return msg.toString();
		}

		if (msgContentBytes != null && msgContentBytes.length > 0) {
			System.out.println("getMsgContent2");
	...
	public CmppSubmitRequestSelfDefinedMessage getCmppSubmitRequestSelfDefinedMessage() {
	...
	public void setCmppSubmitRequestSelfDefinedMessage(
		...
		this.cmppSubmitRequestSelfDefinedMessage = cmppSubmitRequestSelfDefinedMessage;
	}
	...
	public String toString() {
		...
		sb.append("CmppSubmitRequestMessage [msgid=").append(msgid).append(", serviceId=").append(serviceId)
				.append(", srcId=").append(srcId).append(", msgsrc=").append(msgsrc).append(", destterminalId=")
				.append(Arrays.toString(destterminalId)).append(", msgContent=").append(getMsgContent())
	...
	public LongMessageFrame generateFrame() {
		...
		// ly add
		frame.setCmppSubmitRequestSelfDefinedMessage(cmppSubmitRequestSelfDefinedMessage);
		return frame;
	}
