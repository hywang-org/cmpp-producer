...
public class CmppDeliverRequestMessage extends DefaultMessage implements LongSMSMessage<CmppDeliverRequestMessage> {
	...
	// ly add
	private CmppDeliverRequestSelfDefinedMessage cmppDeliverRequestSelfDefinedMessage;

	private String cmppVersion;

	public CmppDeliverRequestSelfDefinedMessage getCmppDeliverRequestSelfDefinedMessage() {
		return cmppDeliverRequestSelfDefinedMessage;
	}

	public void setCmppDeliverRequestSelfDefinedMessage(
			CmppDeliverRequestSelfDefinedMessage cmppDeliverRequestSelfDefinedMessage) {
		this.cmppDeliverRequestSelfDefinedMessage = cmppDeliverRequestSelfDefinedMessage;
	}
	...
	public String toString() {
		if (isReport()) {
			...
			sb.append("CmppDeliverRequestMessage [msgId=").append(msgId).append(", destId=").append(destId)
					.append(", srcterminalId=").append(srcterminalId).append(", getHeader()=").append(getHeader())
					.append(", ReportRequest=").append(getReportRequestMessage()).append("]");
			return sb.toString();
		}
		StringBuilder sb = new StringBuilder();
		sb.append("CmppDeliverRequestMessage [msgId=").append(msgId).append(", destId=").append(destId)
				.append(", srcterminalId=").append(srcterminalId).append(", msgContent=").append(getMsgContent())
